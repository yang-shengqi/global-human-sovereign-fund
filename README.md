...
本体系通过**地理分散**（瑞士、美国、全球区块链）、**技术异构**（学术存档、区块链、代码托管）和**冗余备份**，将文档固化于多个平台。以下按访问用途分为三类：

### 1. 学术引用（首选 DOI）

| 平台 | 链接 | 说明 |
| :--- | :--- | :--- |
| **OSF 项目总入口** | [https://osf.io/qhkv4/](https://osf.io/qhkv4/) — 项目 DOI: [10.17605/OSF.IO/ETM9F](https://doi.org/10.17605/OSF.IO/ETM9F) | 项目主页、元数据、版本记录 |
| **Zenodo 全集** | 各篇独立 DOI，详见下表 | 单篇引用，CERN 长期存档 |
...
以下平台提供免登录的全文阅读，所有文档均已完成上传。

#### ArDrive（基于 Arweave 区块链的永久存储）
...
| 平台 | 类型 | 直达链接 |
| :--- | :--- | :--- |
| **WordPress** | 思想首发阵地（全球阅读） | [https://uncienine.wordpress.com/](https://uncienine.wordpress.com/) |


## 第四部分：多平台存档总表

以下汇总了所有存储平台的类型、地域和状态，便于整体查阅：

| 存储平台 | 类型 | 地域 | 主要用途 | 状态 |
| :--- | :--- | :--- | :--- | :--- |
| **OSF** | 学术项目管理 | 美国 | 项目总入口 + DOI | ✅ 已完成 |
| **Zenodo** | 学术数据存档 | 瑞士（CERN） | 正式学术引用（DOI） | ✅ 已完成 |
| **GitHub** | 代码托管平台 | 美国 | [版本控制与公开分发](https://github.com/yang-shengqi/global-human-sovereign-fund) | ✅ 已完成 |
| **Gitee** | 代码托管平台 | 中国 | [国内镜像访问](https://gitee.com/hermo1980/global-human-sovereign-fund) | ✅ 已完成 |
